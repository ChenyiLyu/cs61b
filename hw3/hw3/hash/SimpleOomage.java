...
public class SimpleOomage implements Oomage {
    ...
    @Override
    /** Compare the other object to this object. Return true if equals. Otherwise, return false.*/
    ...
    public int hashCode() {
        if (!USE_PERFECT_HASH) {
            ...
            return (int) (red*Math.pow(256, 0) + green*Math.pow(256, 1) + blue*Math.pow(256, 2));
        }
    }
